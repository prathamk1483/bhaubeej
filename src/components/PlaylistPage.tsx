...
const playlist: Song[] = [
  { id: 1, title: "Dil to Baccha he ji", file: Music3, cover: Cover1 },
  { id: 2, title: "Ashiya", file: Music1, cover: Cover2 },
  { id: 3, title: "Phoolo Ka Taaron Ka", file: Music2, cover: Cover3 },
];
